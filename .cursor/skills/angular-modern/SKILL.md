---
name: angular-modern
description: Authors and reviews Angular code using the latest patterns in this workspace - zoneless change detection, signals, signal-based inputs/outputs/queries/model, new control flow, and standalone components. Use ONLY when the user explicitly requests this skill.
